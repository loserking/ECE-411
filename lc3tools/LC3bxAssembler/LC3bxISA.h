...
namespace LC3bx
{
	...
	const unsigned int NUM_OPCODES = 37;
...
#include "LC3bxISA.def"
	...
	//*** ISA Lexing ***
		...
		enum OpcodeEnum {ADD = 0, AND, BR, BRp, BRz, BRzp, BRn, BRnp, BRnz, BRnzp, JSR, JSRR, TRAP, JMP, LEA, LDB, LDI, LDR, STB, STI, STR, LSHF, RSHFL, RSHFA, NOT, RET, RTI, NOP, DIV, MULT, SUB, OR, XOR, NOR, XNOR, NAND, LDBSE};
	...
	//*** ISA Instructions ***
		...
		public:
			...
			DivInstr(const LocationVector &, RegisterEnum, RegisterEnum, RegisterEnum);
			virtual ~DivInstr();
		...
		public:
			...
			MultInstr(const LocationVector &, RegisterEnum, RegisterEnum, RegisterEnum);
			virtual ~MultInstr();
		...
		public:
			...
			SubInstr(const LocationVector &, RegisterEnum, RegisterEnum, RegisterEnum);
			virtual ~SubInstr();
		...
		public:
			...
			XorInstr(const LocationVector &, RegisterEnum, RegisterEnum, RegisterEnum);
			virtual ~XorInstr();
		...
		public:
			...
			OrInstr(const LocationVector &, RegisterEnum, RegisterEnum, RegisterEnum);
			virtual ~OrInstr();
		...
		class NorInstr : public Instruction
		{
		public:
			RegisterEnum DR, SR1, SR2;
			...
			NorInstr(const LocationVector &, RegisterEnum, RegisterEnum, RegisterEnum);
			virtual ~NorInstr();
		...
		class XnorInstr : public Instruction
		{
		public:
			RegisterEnum DR, SR1, SR2;
			...
			XnorInstr(const LocationVector &, RegisterEnum, RegisterEnum, RegisterEnum);
			virtual ~XnorInstr();
		...
		class NandInstr : public Instruction
		{
		public:
			RegisterEnum DR, SR1, SR2;
			...
			NandInstr(const LocationVector &, RegisterEnum, RegisterEnum, RegisterEnum);
			virtual ~NandInstr();
